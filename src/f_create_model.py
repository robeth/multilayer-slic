...
from constant import array_path, train_start_index, train_end_index, test_start_index, test_end_index, classifier_path, classifier_extension, category 
...
def create_model(scenario):
    ...
    final_result = {'codename': scenario['codename'],'acc':a_score, 'fn':c_matrix[0,1], 'fp':c_matrix[1,0]}
